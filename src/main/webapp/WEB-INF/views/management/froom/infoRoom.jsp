	...
	<div class="container-fluid">
						...
						<div class="media-body">
							<div class="media align-items-center">
								...
								<div class="col-xl-5 pt-3 border-right">
									...
									<p class="mb-2 pl-2 pb-3 font-weight-light">
										<i class="fab fa-whatsapp text-primary"></i> ${info.f_phone }
									</p>
									<h6 class="mb-3 pl-2">
										${info.f_checkin }|${info.f_checkout }</h6>
		...
		<div class="card shadow mb-4">
			<c:forEach var="info" items="${infoRoom }">
				<a href="#go${info.rm_no }" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="${info.rm_no }">

					<h6 class="m-0 font-weight-bold text-primary">
						<c:out value="${info.rm_no }" />
						<span class="ml-1 font-weight-light"><c:out value="${info.rm_name }" /></span>
					</h6>
										...
										<div class="mb-4">
											...
											<div>
												<h5 class="text-muted font-weight-light">
													...
													<c:out value="${info.rm_max }" />
												</h5>
											</div>
										</div>
										<h6 class="mb-3 font-weight-light">
											<c:out value="${info.rm_info }" />
										</h6>
