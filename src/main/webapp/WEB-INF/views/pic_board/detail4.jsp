                                      ...
                                      <c:forEach items="${followList }" var="followList">
                                        <div class="modal-body border-bottom">
										   <div class="row align-items-center justify-content-between d-flex">
											...
											<tr>
												<td class="text-center"><img src="../img/snsImg/${file.photo_file_name}" style="max-width: 100%;"/></td>
											</tr>
											<tr>
												

												<td>
											            <img id="like" src="/img/snsImg/like.png" width="30" height="30">
											            <img id="clickLike" src="/img/snsImg/clickLike.png" width="30" height="30">
