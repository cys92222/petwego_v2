         ...
         <div class="nk-nav-scroll">
            <ul class="metismenu" id="menu">
               ...
               <li class="mega-menu mega-menu-sm"><a class="has-arrow"
                  href="/facility/search" aria-expanded="false"> <i class="fas fa-hotel"></i><span class="nav-text"
                     id="reservation">숙소찾기</span>
               </a></li>

               <li><a class="has-arrow" href="/board/list"
                  aria-expanded="false"> <i class="far fa-comments"></i>
               ...
               <li><a class="has-arrow" href="/mypage/mypage"
                  aria-expanded="false"> <i class="far fa-user"></i></i>
